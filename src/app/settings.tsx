...
export default function SettingsScreen() {
    ...
    // Pick a readable icon colour based on the active theme brightness
    const iconColor = theme.startsWith("light") ? "#0F2854" : "#E6EAF2";
            ...
            <ScrollView contentContainerStyle={{ padding: 20, gap: 32 }}>
                ...
                <View className="gap-4">
                    ...
                    <View className="bg-surface rounded-2xl border border-border overflow-hidden">
                        ...
                        <Divider />
                        <SettingsRow label="Version" value="1.5.0" />
                    </View>
                </View>
            </ScrollView>
        </SafeAreaView>
